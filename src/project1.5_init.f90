program Project15Init
    ...
    real(dp) :: y_lower,y_upper,y_upper1,y_lower1
    ...
    call apply_leftright(m1,right,y_lower1,y_upper1,1)
    call apply_upperlower(m1,lower1,x_left, x_right,0)
    call apply_upperlower(m1,upper1,x_left, x_right,1)
    call apply_algebraic_center(m1)
    call file_output(m1,file_name)

end program Project15Init